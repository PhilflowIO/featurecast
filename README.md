...
await record({ device: 'iPhone 15 Pro', out: 'dist/feature-xy' }, async (page, demo) => {
...
Stand: Planung. Es gibt noch keinen lauffähigen Code — [PLAN.md](PLAN.md) beschreibt Architektur und die belegten Entscheidungen, [MILESTONES.md](MILESTONES.md) die Ziele in Reihenfolge, [docs/DEVICES.md](docs/DEVICES.md) das Geräte-Konzept.
